...
def apply_pipeline(image, svc, X_scaler, g_heat):
    ...
    window_list_far, slide_far   = window_list(image, x = [100,1280], y = [400,680], w = [64, 64], c = color_list[0])
    window_list_med1, slide_med1 = window_list(image, x = [100,1280], y = [380,700], w = [110, 110], c = color_list[1])
    window_list_med2, slide_med2 = window_list(image, x = [100,1280], y = [380,700], w = [155, 155], c = color_list[2])
    window_list_near, slide_near = window_list(image, x = [100,1280], y = [360,720], w = [200, 200], c = color_list[3])
...
g_heat = deque(maxlen=20)
pipeLambda = lambda img: apply_pipeline(img, svc, X_scaler, g_heat)

clip = VideoFileClip("project_video.mp4").subclip(10,25)
